...
"blog/tags" = [ "Travel", "Sustainability"]
date = "2025-06-08"
draft=false
+++
...
- Emissions per passenger:
  - Airplane: \(emissions = d \times FE\_{\text{airplane}} \times M\)
    - \(d\) : distance (mile)
    - \(FE\_{\text{airplane}}\): emission factor for a medium-haul airplane (kgCO2eq.passenger \(^{-1}\).mile \(^{-1}\)))
    - \(M\): multiplier representing potential non-CO2 effects (2 or 3 according to the literature)
  - Train: \(emissions = d \times FE\_{\text{train}} \times M\)
